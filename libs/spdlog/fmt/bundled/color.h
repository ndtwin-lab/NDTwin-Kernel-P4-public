...
inline void
vprint(FILE* f, const text_style& ts, string_view fmt, format_args args)
{
...
template <typename... T>
void
print(FILE* f, const text_style& ts, format_string<T...> fmt, T&&... args)
{
...
template <typename... T>
void
print(const text_style& ts, format_string<T...> fmt, T&&... args)
{
    return print(stdout, ts, fmt, std::forward<T>(args)...);
}

inline auto
vformat(const text_style& ts, string_view fmt, format_args args) -> std::string
{
    auto buf = memory_buffer();
    detail::vformat_to(buf, ts, fmt, args);
...
template <typename... T>
inline auto
format(const text_style& ts, format_string<T...> fmt, T&&... args) -> std::string
{
...
auto
vformat_to(OutputIt out, const text_style& ts, string_view fmt, format_args args) -> OutputIt
{
...
inline auto
format_to(OutputIt out, const text_style& ts, format_string<T...> fmt, T&&... args) -> OutputIt
{
