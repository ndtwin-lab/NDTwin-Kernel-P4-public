...
struct win32_error : public spdlog_ex
{
    ...
    static std::string format(const std::string& user_message, DWORD error_code = GetLastError())
    {
    ...
    explicit win32_error(const std::string& func_name, DWORD error = GetLastError())
